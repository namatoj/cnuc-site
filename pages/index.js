  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.headingMd}>
        <p>Texts I've written are found <Link href="https://blog.cnuc.nu/">here</Link>. Listed below are some things I've made by myself or in collaboration with others.</p>
      </section>
    <section>
      <ul>
